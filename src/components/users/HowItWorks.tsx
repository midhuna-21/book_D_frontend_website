            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-4xl">
                <div
                    ...
                    <p className="text-center">
                        Learn the steps to easily rent a book through our
                        platform.
                    </p>
                </div>
                ...
                <div
                    ...
                    <p className="text-center">
                        Discover how you can lend your book and help others
                        read.
                    </p>
                </div>
            </div>
                    ...
                    <div className="relative bg-white p-8 rounded-lg shadow-lg w-11/12 md:w-2/3 lg:w-1/2">
                        ...
                        <ol className="list-decimal list-inside space-y-4">
                            ...
                            <li className="flex items-start">
                                ...
                                <span>
                                    Select the book and request to rent it from
                                    the owner.
                                </span>
                            </li>
                            <li className="flex items-start">
                            ...
                            <li className="flex items-start">
                                ...
                                <span>
                                    If your request is rejected, you’ll receive
                                    a notification and won't be able to rent the
                                    book.
                                </span>
                            </li>
                            <li className="flex items-start">
                            ...
                            <li className="flex items-start">
                                <FaMapMarkerAlt className="text-2xl mr-3 text-red-500" />
                                <span>
                                    Pick up the book from the owner within 5
                                    days after the payment is confirmed.
                                </span>
                            </li>
                            <li className="flex items-start">
                                <FaExchangeAlt className="text-2xl mr-3 text-orange-500" />
                                <span>
                                    Both you and the owner need to update the
                                    book status for confirmation of the
                                    handover.
                                </span>
                            </li>
                            <li className="flex items-start">
                                ...
                                <span>
                                    If the handover isn't completed, you'll get
                                    a refund, and the book will no longer be
                                    available to you.
                                </span>
                            </li>
                            <li className="flex items-start">
                            ...
                            <li className="flex items-start">
                                ...
                                <span>
                                    Both you and the owner need to update the
                                    status to confirm the return. Once
                                    confirmed, you’ll receive your security
                                    deposit.
                                </span>
                            </li>
                            <li className="flex items-start">
                                ...
                                <span>
                                    If you damage the book or fail to return it,
                                    the security deposit will go to the owner.
                                </span>
                            </li>
                        </ol>
                    </div>
                    ...
                    <div className="relative bg-white p-8 rounded-lg shadow-lg w-11/12 md:w-2/3 lg:w-1/2">
                        ...
                        <ol className="list-decimal list-inside space-y-4">
                            <li className="flex items-start">
                                <FaCheckCircle className="text-2xl mr-3 text-green-500" />
                                <span>
                                    Go to the 'Rent Book' section and fill out
                                    the form with all required details,
                            ...
                            <li className="flex items-start">
                                <FaMapMarkerAlt className="text-2xl mr-3 text-red-500" />
                                <span>
                                    Make sure the location is correct and the
                                    book’s availability is clear.
                                </span>
                            </li>
                            <li className="flex items-start">
                                <FaCheckCircle className="text-2xl mr-3 text-green-500" />
                                <span>
                                    Once you submit, your book will be listed
                                    for rent.
                                </span>
                            </li>
                            <li className="flex items-start">
                            ...
                            <li className="flex items-start">
                                <FaMoneyBillWave className="text-2xl mr-3 text-green-500" />
                                <span>
                                    If you accept, the user will be sent a
                                    payment link. After payment, they’ll pick up
                                    the book from you.
                                </span>
                            </li>
                            <li className="flex items-start">
                                <FaExchangeAlt className="text-2xl mr-3 text-orange-500" />
                                <span>
                                    Both you and the user need to update the
                                    book’s status for confirmation of handover.
                                </span>
                            </li>
                            <li className="flex items-start">
                                <FaCheckCircle className="text-2xl mr-3 text-green-500" />
                                <span>
                                    After the user returns the book, both
                                    parties must update the status again to
                                    confirm the return.
                                </span>
                            </li>
                            <li className="flex items-start">
                                <FaMoneyBillWave className="text-2xl mr-3 text-green-500" />
                                <span>
                                    Once confirmed, the payment will be
