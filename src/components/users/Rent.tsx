        ...
        if (searchQuery) {
            filtered = filtered.filter((order) => {
                return (
                    ...
                    order.lenderId.name.toLowerCase().includes(searchQuery)
                );
            });
        }
        return filtered;
                                    ...
                                    {currentOrders.map((order) => (
                                        <tr
                                            ...
                                            <td className="py-3 px-6 text-center whitespace-nowrap">
                                                {order.bookStatus ===
                                                "completed" ? (
                                                    <span className="bg-green-200 text-green-800 font-semibold rounded p-1">
                                                        Returned
                                                    </span>
                                                ) : order.bookStatus ===
                                                  "not_returned" ? (
                                                    <span className="bg-red-200 text-red-800 font-semibold rounded p-1">
                                                        Not Returned
                                                    </span>
                                                ) : order.bookStatus ===
                                                  "cancelled" ? (
                                                    <span className="bg-red-300 text-red-900 font-semibold rounded p-1">
                                                        Cancelled
                                                    </span>
                                                ) : order.bookStatus ===
                                                  "overdue" ? (
                                                    <span className="bg-yellow-200 text-yellow-800 font-semibold rounded p-1">
                                                        Overdue
                                                    </span>
                                                ) : (
                                                    <span className="bg-orange-200 text-orange-800 font-semibold rounded p-1">
                                                        Pending
                                                    </span>
                                                )}
                                            </td>
                                    ...
                                    <div
                                        ...
                                        <div className="flex justify-between items-center mb-3">
                                            ...
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-blue-600 underline hover:text-blue-800 truncate w-[50%]">
                                                {order?.bookAddress}
                                            </a>
                                        </div>
            ...
            {showModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white rounded-lg shadow-lg p-8 max-w-lg w-full">
                        ...
                        <p className="mb-6">
                            Please enter the return code provided by the lender
                            to confirm the book return to confirm the return of
                            the book
                        </p>
                        ...
                        Enter Return Code
                            ...
                            <input
                                ...
                                placeholder="Enter the return code"
